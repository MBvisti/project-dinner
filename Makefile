...
dev: vet format
	...
	@docker run --rm -e DEVELOPMENT_MODE=true -e DATABASE_URL="postgres://postgres:postgres@host.docker.internal/bandlokaler_test?sslmode=disable" -p 5000:5000 ${REGISTRY}/${OUT}:${VERSION}
